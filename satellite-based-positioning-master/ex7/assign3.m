...
% Last Modified by GUIDE v2.5 19-Nov-2018 13:51:33
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    [prs, satPosPred, visibilities, xsol] = simulation7(epoch, sp3, llh, TECU, recerr);
    
    consParams = struct('a',6378137.0,'f',1/298.257223563);
    [xo,yo,zo] = llhtoCartesian(lati, longi, alti, consParams);
    
    set(handles.edit10,'String',num2str(xo));
    set(handles.edit11,'String',num2str(yo));
    set(handles.edit12,'String',num2str(zo));
    set(handles.edit13,'String',num2str(recerr));
    
    set(handles.edit14,'String',num2str(xsol(1)));
    set(handles.edit15,'String',num2str(xsol(2)));
    set(handles.edit16,'String',num2str(xsol(3)));
    set(handles.edit17,'String',num2str(xsol(4)*1000));%% s to ms
    ...
    for i = 1:size(satPosPred,1)
        if visibilities(i) == 1
            ...
            obj.texts(i).String = strcat('pr=',num2str(prs(i,1)));
        else
            line = [[0, 0, 0];[0,0,0]];
            obj.HTrajectories(i).XData = line(:,1);
            obj.HTrajectories(i).YData = line(:,2);
