...
\end{columns}
	...
	\frame{
		...
		\begin{columns}
			...
			The resulting set of point pairs typically
contains several wrong correspondences
			\column[c]{.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=1.\textwidth]{figures/sift.png}
	...
	A robust estimation method provides a good
estimate of 2 despite the presence of
erroneous correspondences (outliers)
	}
