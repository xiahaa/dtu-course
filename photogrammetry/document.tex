...
\begin{document}
	...
	\frame{
		\frametitle{Low-level features: edges}
		 \begin{figure}
			\centering
			\includegraphics[width=0.9\textwidth]{figures/edge.jpg}
		\end{figure}	
	}
	\frame{
	...
	\frame{
		\frametitle{High-level features: road}
		 \begin{figure}
			...
			\caption{Sign detection from \cite{c14}}
		\end{figure}	
	}	
		...
		\frametitle{Application of Point features: Visual odometry}
			\begin{figure}
				...
				\begin{minipage}{1\textwidth}
					\centering
					%			\includegraphics[width=7cm, height=4cm]{figures/viso}
					%			\caption{Feature based visual odometry.}
	...
	\frame{
		\frametitle{Application of Point features: Mosaicing}
			\begin{figure}
				...
				\begin{minipage}{1\textwidth}
					\centering
%					\animategraphics[loop,controls,width=0.65\linewidth]{10}{figures/map2dfusion/img}{0}{289}
...
\end{columns}
	...
	\begin{columns}
		...
		\begin{figure}
			...
			\includegraphics[scale=0.12]{figures/desp2.png}
	...
	\frame{
		...
		\begin{columns}
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.8\textwidth]{figures/ransac7.png}
...
contaminated.
	...
	\frame{
		\frametitle{How many iterations to choose}
		A look-up table for $N$ when $p$ i set to $0.99$.
		\begin{table}
